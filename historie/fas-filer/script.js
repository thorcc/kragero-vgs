...
var ENDSHOW_MESG="Lysbildefremvisning er slutt: Klikk for å avslutte.", SCREEN_MODE="Frames", gIsEndShow=0, NUM_VIS_SLDS=12, SCRIPT_HREF="script.js", FULLSCR_HREF="fullscreen.htm";
...
var gDocTable = new Array(
   new hrefList("slide0070.htm", 1, 1),
   new hrefList("slide0159.htm", 1, 2),
   new hrefList("slide0071.htm", 1, 3),
   new hrefList("slide0163.htm", 1, 4),
   new hrefList("slide0072.htm", 1, 5),
   new hrefList("slide0073.htm", 1, 6),
   new hrefList("slide0160.htm", 1, 7),
   new hrefList("slide0164.htm", 1, 8),
   new hrefList("slide0074.htm", 1, 9),
   new hrefList("slide0161.htm", 1, 10),
   new hrefList("slide0075.htm", 1, 11),
   new hrefList("slide0162.htm", 1, 12)
);
