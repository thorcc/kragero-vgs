...
var ENDSHOW_MESG="Lysbildefremvisning er slutt: Klikk for å avslutte.", SCREEN_MODE="Frames", gIsEndShow=0, NUM_VIS_SLDS=16, SCRIPT_HREF="script.js", FULLSCR_HREF="fullscreen.htm";
...
var gDocTable = new Array(
   new hrefList("slide0128.htm", 1, 1),
   new hrefList("slide0124.htm", 1, 2),
   new hrefList("slide0125.htm", 1, 3),
   new hrefList("slide0126.htm", 1, 4),
   new hrefList("slide0129.htm", 1, 5),
   new hrefList("slide0110.htm", 1, 6),
   new hrefList("slide0111.htm", 1, 7),
   new hrefList("slide0112.htm", 1, 8),
   new hrefList("slide0130.htm", 1, 9),
   new hrefList("slide0114.htm", 1, 10),
   new hrefList("slide0115.htm", 1, 11),
   new hrefList("slide0116.htm", 1, 12),
   new hrefList("slide0117.htm", 1, 13),
   new hrefList("slide0118.htm", 1, 14),
   new hrefList("slide0119.htm", 1, 15),
   new hrefList("slide0120.htm", 1, 16)
);
...
var sNext="Neste",sPrev="Forrige",sEnd="Avslutt fremvisning",sFont="Arial"
function ShowMenu()
{
	BuildMenu();
