...
var ENDSHOW_MESG="Lysbildefremvisning er slutt: Klikk for å avslutte.", SCREEN_MODE="Frames", gIsEndShow=0, NUM_VIS_SLDS=10, SCRIPT_HREF="script.js", FULLSCR_HREF="fullscreen.htm";
...
var gDocTable = new Array(
   new hrefList("slide0098.htm", 1, 1),
   new hrefList("slide0099.htm", 1, 2),
   new hrefList("slide0127.htm", 1, 3),
   new hrefList("slide0103.htm", 1, 4),
   new hrefList("slide0121.htm", 1, 5),
   new hrefList("slide0104.htm", 1, 6),
   new hrefList("slide0107.htm", 1, 7),
   new hrefList("slide0122.htm", 1, 8),
   new hrefList("slide0123.htm", 1, 9),
   new hrefList("slide0108.htm", 1, 10)
);
