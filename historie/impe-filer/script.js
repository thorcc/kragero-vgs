...
var ENDSHOW_MESG="Lysbildefremvisning er slutt: Klikk for å avslutte.", SCREEN_MODE="Frames", gIsEndShow=0, NUM_VIS_SLDS=6, SCRIPT_HREF="script.js", FULLSCR_HREF="fullscreen.htm";
...
var gDocTable = new Array(
   ...
   new hrefList("slide0017.htm", 1, 2),
   new hrefList("slide0019.htm", 1, 3),
   new hrefList("slide0020.htm", 1, 4),
   new hrefList("slide0021.htm", 1, 5),
   new hrefList("slide0022.htm", 1, 6)
);
