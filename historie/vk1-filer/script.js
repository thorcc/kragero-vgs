...
var ENDSHOW_MESG="Lysbildefremvisning er slutt: Klikk for å avslutte.", SCREEN_MODE="Frames", gIsEndShow=0, NUM_VIS_SLDS=8, SCRIPT_HREF="script.js", FULLSCR_HREF="fullscreen.htm";
...
var gDocTable = new Array(
   new hrefList("slide0049.htm", 1, 1),
   new hrefList("slide0050.htm", 1, 2),
   new hrefList("slide0051.htm", 1, 3),
   new hrefList("slide0052.htm", 1, 4),
   new hrefList("slide0044.htm", 1, 5),
   new hrefList("slide0045.htm", 1, 6),
   new hrefList("slide0048.htm", 1, 7),
