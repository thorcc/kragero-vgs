...
var ENDSHOW_MESG="Lysbildefremvisning er slutt: Klikk for å avslutte.", SCREEN_MODE="Frames", gIsEndShow=0, NUM_VIS_SLDS=9, SCRIPT_HREF="script.js", FULLSCR_HREF="fullscreen.htm";
...
var gDocTable = new Array(
   new hrefList("slide0076.htm", 1, 1),
   new hrefList("slide0077.htm", 1, 2),
   new hrefList("slide0078.htm", 1, 3),
   new hrefList("slide0079.htm", 1, 4),
   new hrefList("slide0080.htm", 1, 5),
   new hrefList("slide0081.htm", 1, 6),
   new hrefList("slide0082.htm", 1, 7),
   new hrefList("slide0083.htm", 1, 8),
   new hrefList("slide0084.htm", 1, 9)
);
