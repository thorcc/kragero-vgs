...
var gDocTable = new Array(
   new hrefList("slide0145.htm", 1, 1),
   new hrefList("slide0146.htm", 1, 2),
   new hrefList("slide0147.htm", 1, 3),
   new hrefList("slide0156.htm", 1, 4),
   new hrefList("slide0148.htm", 1, 5),
   new hrefList("slide0149.htm", 1, 6),
   new hrefList("slide0150.htm", 1, 7),
   new hrefList("slide0151.htm", 1, 8),
   new hrefList("slide0152.htm", 1, 9),
   new hrefList("slide0153.htm", 1, 10),
   new hrefList("slide0154.htm", 1, 11),
   new hrefList("slide0155.htm", 1, 12)
);
