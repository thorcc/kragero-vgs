...
var ENDSHOW_MESG="Lysbildefremvisning er slutt: Klikk for å avslutte.", SCREEN_MODE="Frames", gIsEndShow=0, NUM_VIS_SLDS=11, SCRIPT_HREF="script.js", FULLSCR_HREF="fullscreen.htm";
...
var gDocTable = new Array(
   new hrefList("slide0016.htm", 1, 1),
   new hrefList("slide0021.htm", 1, 2),
   new hrefList("slide0022.htm", 1, 3),
   new hrefList("slide0023.htm", 1, 4),
   new hrefList("slide0026.htm", 1, 5),
   new hrefList("slide0014.htm", 1, 6),
   new hrefList("slide0015.htm", 1, 7),
   new hrefList("slide0027.htm", 1, 8),
   new hrefList("slide0025.htm", 1, 9),
   new hrefList("slide0024.htm", 1, 10),
   new hrefList("slide0020.htm", 1, 11)
);
