...
var gDocTable = new Array(
   new hrefList("slide0018.htm", 1, 1),
   new hrefList("slide0019.htm", 1, 2),
   new hrefList("slide0002.htm", 1, 3),
   new hrefList("slide0017.htm", 1, 4),
   new hrefList("slide0001.htm", 1, 5),
   new hrefList("slide0004.htm", 1, 6),
   new hrefList("slide0003.htm", 1, 7),
   new hrefList("slide0011.htm", 1, 8),
   new hrefList("slide0005.htm", 1, 9),
   new hrefList("slide0007.htm", 1, 10),
   ...
   new hrefList("slide0012.htm", 1, 15),
